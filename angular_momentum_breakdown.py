...
def angular_momenta_data(halo, subhalo, tag, simulation):
...
def angular_momentum_fraction(target_particle_type, halo, subhalo, tag, simulation):
    angular_momenta, net_angular_momentum = angular_momenta_data(halo, subhalo, tag, simulation)
...
def gas_star_angular_momentum_angle(halo, subhalo, tag, simulation):
    angular_momenta, _ = angular_momenta_data(halo, subhalo, tag, simulation)
